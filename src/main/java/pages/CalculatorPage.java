...
public class CalculatorPage extends BasePage {
    ...
    private By computeEngine = By.xpath("//div[contains (text(), 'e2-standard-8 (vCPUs: 8, RAM: 32GB)')]");
...
//        new WebDriverWait(driver, 5).until(ExpectedConditions.elementToBeSelected(computeEngine));
